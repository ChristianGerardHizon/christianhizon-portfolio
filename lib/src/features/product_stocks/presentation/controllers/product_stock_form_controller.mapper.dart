...
class ProductStockFormStateMapper
  ...
  static const Field<ProductStockFormState, Product> _f$product = Field(
    'product',
    _$product,
  );
...
mixin ProductStockFormStateMappable {
  ...
  ProductStockFormStateCopyWith<
    ProductStockFormState,
    ProductStockFormState,
    ProductStockFormState
  >
  get copyWith =>
      _ProductStockFormStateCopyWithImpl<
        ProductStockFormState,
        ProductStockFormState
      >(this as ProductStockFormState, $identity, $identity);
  @override
  String toString() {
    return ProductStockFormStateMapper.ensureInitialized().stringifyValue(
      this as ProductStockFormState,
    );
  }

  @override
  bool operator ==(Object other) {
    return ProductStockFormStateMapper.ensureInitialized().equalsValue(
      this as ProductStockFormState,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ProductStockFormStateMapper.ensureInitialized().hashValue(
      this as ProductStockFormState,
    );
  }
}
...
class _ProductStockFormStateCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Product? product, Object? productStock = $none}) => $apply(
    FieldCopyWithData({
