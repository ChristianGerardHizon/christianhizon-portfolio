...
class ProductStockMapper extends ClassMapperBase<ProductStock> {
  ...
  static const Field<ProductStock, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(ProductStock v) => v.collectionName;
  static const Field<ProductStock, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
  static DateTime? _$created(ProductStock v) => v.created;
  static const Field<ProductStock, DateTime> _f$created = Field(
    'created',
    _$created,
  );
  static bool _$isDeleted(ProductStock v) => v.isDeleted;
  static const Field<ProductStock, bool> _f$isDeleted = Field(
    'isDeleted',
    _$isDeleted,
  );
  static DateTime? _$updated(ProductStock v) => v.updated;
  static const Field<ProductStock, DateTime> _f$updated = Field(
    'updated',
    _$updated,
  );
  static String _$product(ProductStock v) => v.product;
  static const Field<ProductStock, String> _f$product = Field(
    'product',
    _$product,
  );
  static String? _$lotNo(ProductStock v) => v.lotNo;
  static const Field<ProductStock, String> _f$lotNo = Field(
    'lotNo',
    _$lotNo,
    opt: true,
  );
  static DateTime? _$expiration(ProductStock v) => v.expiration;
  static const Field<ProductStock, DateTime> _f$expiration = Field(
    'expiration',
    _$expiration,
    opt: true,
    hook: DateTimeHook(),
  ...
  static const Field<ProductStock, String> _f$notes = Field(
    'notes',
    _$notes,
    opt: true,
  );
  static int? _$quantity(ProductStock v) => v.quantity;
  static const Field<ProductStock, int> _f$quantity = Field(
    'quantity',
    _$quantity,
    opt: true,
  );
  static bool _$isDisposed(ProductStock v) => v.isDisposed;
  static const Field<ProductStock, bool> _f$isDisposed = Field(
    'isDisposed',
    _$isDisposed,
    opt: true,
    def: false,
  ...
  static ProductStock _instantiate(DecodingData data) {
    return ProductStock(
      ...
      isDisposed: data.dec(_f$isDisposed),
    );
  }
...
mixin ProductStockMappable {
  String toJson() {
    return ProductStockMapper.ensureInitialized().encodeJson<ProductStock>(
      this as ProductStock,
    );
  }

  Map<String, dynamic> toMap() {
    return ProductStockMapper.ensureInitialized().encodeMap<ProductStock>(
      this as ProductStock,
    );
  }
  ...
  @override
  String toString() {
    return ProductStockMapper.ensureInitialized().stringifyValue(
      this as ProductStock,
    );
  }
  ...
  bool operator ==(Object other) {
    return ProductStockMapper.ensureInitialized().equalsValue(
      this as ProductStock,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ProductStockMapper.ensureInitialized().hashValue(
      this as ProductStock,
    );
  }
}
...
class _ProductStockCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (isDisposed != null) #isDisposed: isDisposed,
    }),
  );
  @override
  ProductStock $make(CopyWithData data) => ProductStock(
    ...
    isDisposed: data.get(#isDisposed, or: $value.isDisposed),
  );
