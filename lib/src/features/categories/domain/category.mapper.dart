...
class CategoryMapper extends ClassMapperBase<Category> {
  ...
  static const Field<Category, bool> _f$isDeleted =
      Field('isDeleted', _$isDeleted, opt: true, def: false);
  static DateTime? _$created(Category v) => v.created;
  static const Field<Category, DateTime> _f$created =
      Field('created', _$created);
  static DateTime? _$updated(Category v) => v.updated;
  static const Field<Category, DateTime> _f$updated =
