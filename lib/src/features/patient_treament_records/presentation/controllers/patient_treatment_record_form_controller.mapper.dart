...
class PatientTreatmentRecordFormStateMapper
  ...
  static PatientTreatmentRecordFormStateMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = PatientTreatmentRecordFormStateMapper._());
  ...
  static const Field<PatientTreatmentRecordFormState, PatientTreatmentRecord>
      _f$patientTreatmentRecord =
      Field('patientTreatmentRecord', _$patientTreatmentRecord);
  ...
  static const Field<PatientTreatmentRecordFormState, List<PatientTreatment>>
      _f$patientTreatments =
      Field('patientTreatments', _$patientTreatments, opt: true, def: const []);
  static AuthData _$auth(PatientTreatmentRecordFormState v) => v.auth;
  static const Field<PatientTreatmentRecordFormState, AuthData> _f$auth =
      Field('auth', _$auth);
  ...
  static PatientTreatmentRecordFormState fromJson(String json) {
    return ensureInitialized()
        .decodeJson<PatientTreatmentRecordFormState>(json);
  }
}
...
mixin PatientTreatmentRecordFormStateMappable {
  ...
  PatientTreatmentRecordFormStateCopyWith<PatientTreatmentRecordFormState,
          PatientTreatmentRecordFormState, PatientTreatmentRecordFormState>
      get copyWith => _PatientTreatmentRecordFormStateCopyWithImpl<
              PatientTreatmentRecordFormState, PatientTreatmentRecordFormState>(
  ...
  int get hashCode {
    return PatientTreatmentRecordFormStateMapper.ensureInitialized()
        .hashValue(this as PatientTreatmentRecordFormState);
  }
}

extension PatientTreatmentRecordFormStateValueCopy<$R, $Out>
    on ObjectCopyWith<$R, PatientTreatmentRecordFormState, $Out> {
  PatientTreatmentRecordFormStateCopyWith<$R, PatientTreatmentRecordFormState,
          $Out>
      get $asPatientTreatmentRecordFormState => $base.as((v, t, t2) =>
...
abstract class PatientTreatmentRecordFormStateCopyWith<
  ...
  PatientTreatmentRecordCopyWith<$R, PatientTreatmentRecord,
      PatientTreatmentRecord>? get patientTreatmentRecord;
  PatientCopyWith<$R, Patient, Patient> get patient;
  ListCopyWith<$R, Branch, BranchCopyWith<$R, Branch, Branch>> get branches;
  ListCopyWith<$R, PatientTreatment,
...
class _PatientTreatmentRecordFormStateCopyWithImpl<$R, $Out>
    ...
    implements
        PatientTreatmentRecordFormStateCopyWith<$R,
            PatientTreatmentRecordFormState, $Out> {
  ...
  PatientTreatmentRecordCopyWith<$R, PatientTreatmentRecord,
      ...
      get patientTreatmentRecord => $value.patientTreatmentRecord?.copyWith
          .$chain((v) => call(patientTreatmentRecord: v));
  @override
  PatientCopyWith<$R, Patient, Patient> get patient =>
  ...
  ListCopyWith<$R, PatientTreatment,
          PatientTreatmentCopyWith<$R, PatientTreatment, PatientTreatment>>
      get patientTreatments => ListCopyWith($value.patientTreatments,
          (v, t) => v.copyWith.$chain(t), (v) => call(patientTreatments: v));
  @override
  $R call(
  ...
  PatientTreatmentRecordFormState $make(CopyWithData data) =>
      PatientTreatmentRecordFormState(
          patientTreatmentRecord: data.get(#patientTreatmentRecord,
              or: $value.patientTreatmentRecord),
          patient: data.get(#patient, or: $value.patient),
          branches: data.get(#branches, or: $value.branches),
          patientTreatments:
              data.get(#patientTreatments, or: $value.patientTreatments),
          auth: data.get(#auth, or: $value.auth));

  @override
  PatientTreatmentRecordFormStateCopyWith<$R2, PatientTreatmentRecordFormState,
      $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
