...
class PatientTreatmentRecordMapper
  ...
  static const Field<PatientTreatmentRecord, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(PatientTreatmentRecord v) => v.collectionName;
  static const Field<PatientTreatmentRecord, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
  static String _$treatment(PatientTreatmentRecord v) => v.treatment;
  static const Field<PatientTreatmentRecord, String> _f$treatment = Field(
    'treatment',
    _$treatment,
  );
  static String _$patient(PatientTreatmentRecord v) => v.patient;
  static const Field<PatientTreatmentRecord, String> _f$patient = Field(
    'patient',
    _$patient,
  );
...
>
  ...
  PatientTreatmentRecordExpandCopyWith<
    $R,
  ...
  static PatientTreatmentRecordExpandMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = PatientTreatmentRecordExpandMapper._(),
      );
...
mixin PatientTreatmentRecordExpandMappable {
  ...
  @override
  bool operator ==(Object other) {
    return PatientTreatmentRecordExpandMapper.ensureInitialized().equalsValue(
      this as PatientTreatmentRecordExpand,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PatientTreatmentRecordExpandMapper.ensureInitialized().hashValue(
      this as PatientTreatmentRecordExpand,
    );
  }
}
...
extension PatientTreatmentRecordExpandValueCopy<$R, $Out>
  ...
  get $asPatientTreatmentRecordExpand => $base.as(
    (v, t, t2) => _PatientTreatmentRecordExpandCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _PatientTreatmentRecordExpandCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _PatientTreatmentRecordExpandCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
