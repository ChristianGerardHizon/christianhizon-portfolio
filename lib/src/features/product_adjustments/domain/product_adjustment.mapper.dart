...
class ProductAdjustmentMapper extends SubClassMapperBase<ProductAdjustment> {
  ...
  static ProductAdjustment _instantiate(DecodingData data) {
    throw MapperException.missingSubclass(
        'ProductAdjustment', 'type', '${data.value['type']}');
  }
...
mixin ProductAdjustmentMappable {
  ...
  ProductAdjustmentCopyWith<ProductAdjustment, ProductAdjustment,
      ProductAdjustment> get copyWith;
}

abstract class ProductAdjustmentCopyWith<$R, $In extends ProductAdjustment,
...
class ProductAdjustmentSimpleMapper
  ...
  static ProductAdjustmentSimpleMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = ProductAdjustmentSimpleMapper._());
  ...
  static const Field<ProductAdjustmentSimple, String> _f$product =
  ...
  static const Field<ProductAdjustmentSimple, String> _f$collectionId =
      Field('collectionId', _$collectionId);
  static String _$collectionName(ProductAdjustmentSimple v) => v.collectionName;
  static const Field<ProductAdjustmentSimple, String> _f$collectionName =
      Field('collectionName', _$collectionName);
  static bool _$isDeleted(ProductAdjustmentSimple v) => v.isDeleted;
  static const Field<ProductAdjustmentSimple, bool> _f$isDeleted =
      Field('isDeleted', _$isDeleted, opt: true, def: false);
  static DateTime? _$created(ProductAdjustmentSimple v) => v.created;
  static const Field<ProductAdjustmentSimple, DateTime> _f$created =
      Field('created', _$created, opt: true);
  static DateTime? _$updated(ProductAdjustmentSimple v) => v.updated;
  static const Field<ProductAdjustmentSimple, DateTime> _f$updated =
      Field('updated', _$updated, opt: true);
  static num _$oldValue(ProductAdjustmentSimple v) => v.oldValue;
  static const Field<ProductAdjustmentSimple, num> _f$oldValue =
      Field('oldValue', _$oldValue);
  static num _$newValue(ProductAdjustmentSimple v) => v.newValue;
  static const Field<ProductAdjustmentSimple, num> _f$newValue =
      Field('newValue', _$newValue);
  ...
  static const Field<ProductAdjustmentSimple, String> _f$reason =
      Field('reason', _$reason, opt: true);
...
mixin ProductAdjustmentSimpleMappable {
  ...
  ProductAdjustmentSimpleCopyWith<ProductAdjustmentSimple,
          ProductAdjustmentSimple, ProductAdjustmentSimple>
      get copyWith => _ProductAdjustmentSimpleCopyWithImpl<
              ProductAdjustmentSimple, ProductAdjustmentSimple>(
          this as ProductAdjustmentSimple, $identity, $identity);
  @override
  String toString() {
    return ProductAdjustmentSimpleMapper.ensureInitialized()
        .stringifyValue(this as ProductAdjustmentSimple);
  }

  @override
  bool operator ==(Object other) {
    return ProductAdjustmentSimpleMapper.ensureInitialized()
        .equalsValue(this as ProductAdjustmentSimple, other);
  }

  @override
  int get hashCode {
    return ProductAdjustmentSimpleMapper.ensureInitialized()
        .hashValue(this as ProductAdjustmentSimple);
  }
}
...
extension ProductAdjustmentSimpleValueCopy<$R, $Out>
  ...
  ProductAdjustmentSimpleCopyWith<$R, ProductAdjustmentSimple, $Out>
      get $asProductAdjustmentSimple => $base.as((v, t, t2) =>
          _ProductAdjustmentSimpleCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ProductAdjustmentSimpleCopyWith<
    $R,
    $In extends ProductAdjustmentSimple,
    $Out> implements ProductAdjustmentCopyWith<$R, $In, $Out> {
  ProductAdjustmentSimpleExpandCopyWith<$R, ProductAdjustmentSimpleExpand,
      ProductAdjustmentSimpleExpand> get expand;
  @override
  $R call(
      {String? product,
      String? id,
...
class ProductAdjustmentSimpleExpandMapper
  ...
  static ProductAdjustmentSimpleExpandMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = ProductAdjustmentSimpleExpandMapper._());
  ...
  static const Field<ProductAdjustmentSimpleExpand, Product> _f$product =
...
mixin ProductAdjustmentSimpleExpandMappable {
  ...
  ProductAdjustmentSimpleExpandCopyWith<ProductAdjustmentSimpleExpand,
          ProductAdjustmentSimpleExpand, ProductAdjustmentSimpleExpand>
      get copyWith => _ProductAdjustmentSimpleExpandCopyWithImpl<
              ProductAdjustmentSimpleExpand, ProductAdjustmentSimpleExpand>(
  ...
  bool operator ==(Object other) {
    return ProductAdjustmentSimpleExpandMapper.ensureInitialized()
        .equalsValue(this as ProductAdjustmentSimpleExpand, other);
  }

  @override
  int get hashCode {
    return ProductAdjustmentSimpleExpandMapper.ensureInitialized()
        .hashValue(this as ProductAdjustmentSimpleExpand);
  }
}
...
extension ProductAdjustmentSimpleExpandValueCopy<$R, $Out>
  ...
  ProductAdjustmentSimpleExpandCopyWith<$R, ProductAdjustmentSimpleExpand, $Out>
      get $asProductAdjustmentSimpleExpand => $base.as((v, t, t2) =>
...
class _ProductAdjustmentSimpleExpandCopyWithImpl<$R, $Out>
  ...
  @override
  ProductAdjustmentSimpleExpandCopyWith<$R2, ProductAdjustmentSimpleExpand,
      $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
...
class ProductAdjustmentStockMapper
  ...
  static const Field<ProductAdjustmentStock, String> _f$productStock =
  ...
  static const Field<ProductAdjustmentStock, String> _f$collectionId =
      Field('collectionId', _$collectionId);
  static String _$collectionName(ProductAdjustmentStock v) => v.collectionName;
  static const Field<ProductAdjustmentStock, String> _f$collectionName =
      Field('collectionName', _$collectionName);
  static bool _$isDeleted(ProductAdjustmentStock v) => v.isDeleted;
  static const Field<ProductAdjustmentStock, bool> _f$isDeleted =
      Field('isDeleted', _$isDeleted, opt: true, def: false);
  static DateTime? _$created(ProductAdjustmentStock v) => v.created;
  static const Field<ProductAdjustmentStock, DateTime> _f$created =
      Field('created', _$created, opt: true);
  static DateTime? _$updated(ProductAdjustmentStock v) => v.updated;
  static const Field<ProductAdjustmentStock, DateTime> _f$updated =
      Field('updated', _$updated, opt: true);
  static num _$oldValue(ProductAdjustmentStock v) => v.oldValue;
  static const Field<ProductAdjustmentStock, num> _f$oldValue =
      Field('oldValue', _$oldValue);
  static num _$newValue(ProductAdjustmentStock v) => v.newValue;
  static const Field<ProductAdjustmentStock, num> _f$newValue =
      Field('newValue', _$newValue);
  ...
  static const Field<ProductAdjustmentStock, String> _f$reason =
      Field('reason', _$reason, opt: true);
...
mixin ProductAdjustmentStockMappable {
  ...
  ProductAdjustmentStockCopyWith<ProductAdjustmentStock, ProductAdjustmentStock,
          ProductAdjustmentStock>
      get copyWith => _ProductAdjustmentStockCopyWithImpl<
              ProductAdjustmentStock, ProductAdjustmentStock>(
          this as ProductAdjustmentStock, $identity, $identity);
  @override
  String toString() {
    return ProductAdjustmentStockMapper.ensureInitialized()
        .stringifyValue(this as ProductAdjustmentStock);
  }

  @override
  bool operator ==(Object other) {
    return ProductAdjustmentStockMapper.ensureInitialized()
        .equalsValue(this as ProductAdjustmentStock, other);
  }

  @override
  int get hashCode {
    return ProductAdjustmentStockMapper.ensureInitialized()
        .hashValue(this as ProductAdjustmentStock);
  }
}
...
extension ProductAdjustmentStockValueCopy<$R, $Out>
  ...
  ProductAdjustmentStockCopyWith<$R, ProductAdjustmentStock, $Out>
      get $asProductAdjustmentStock => $base.as((v, t, t2) =>
          _ProductAdjustmentStockCopyWithImpl<$R, $Out>(v, t, t2));
}
...
abstract class ProductAdjustmentStockCopyWith<
    ...
    $Out> implements ProductAdjustmentCopyWith<$R, $In, $Out> {
  ProductAdjustmentStockExpandCopyWith<$R, ProductAdjustmentStockExpand,
      ProductAdjustmentStockExpand> get expand;
  @override
  $R call(
      {String? productStock,
      String? id,
...
class ProductAdjustmentStockExpandMapper
  ...
  static ProductAdjustmentStockExpandMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = ProductAdjustmentStockExpandMapper._());
...
mixin ProductAdjustmentStockExpandMappable {
  ...
  ProductAdjustmentStockExpandCopyWith<ProductAdjustmentStockExpand,
          ProductAdjustmentStockExpand, ProductAdjustmentStockExpand>
      get copyWith => _ProductAdjustmentStockExpandCopyWithImpl<
              ProductAdjustmentStockExpand, ProductAdjustmentStockExpand>(
  ...
  bool operator ==(Object other) {
    return ProductAdjustmentStockExpandMapper.ensureInitialized()
        .equalsValue(this as ProductAdjustmentStockExpand, other);
  }

  @override
  int get hashCode {
    return ProductAdjustmentStockExpandMapper.ensureInitialized()
        .hashValue(this as ProductAdjustmentStockExpand);
  }
}
...
extension ProductAdjustmentStockExpandValueCopy<$R, $Out>
  ...
  ProductAdjustmentStockExpandCopyWith<$R, ProductAdjustmentStockExpand, $Out>
      get $asProductAdjustmentStockExpand => $base.as((v, t, t2) =>
          _ProductAdjustmentStockExpandCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _ProductAdjustmentStockExpandCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({ProductStock? productStock}) => $apply(FieldCopyWithData(
      {if (productStock != null) #productStock: productStock}));
  @override
  ...
  ProductAdjustmentStockExpandCopyWith<$R2, ProductAdjustmentStockExpand, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _ProductAdjustmentStockExpandCopyWithImpl<$R2, $Out2>(
              $value, $cast, t);
}
