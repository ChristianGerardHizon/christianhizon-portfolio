...
class PatientFileMapper extends ClassMapperBase<PatientFile> {
  ...
  static const Field<PatientFile, String> _f$notes =
...
mixin PatientFileMappable {
  String toJson() {
    return PatientFileMapper.ensureInitialized()
        .encodeJson<PatientFile>(this as PatientFile);
  }

  Map<String, dynamic> toMap() {
    return PatientFileMapper.ensureInitialized()
        .encodeMap<PatientFile>(this as PatientFile);
  }

  PatientFileCopyWith<PatientFile, PatientFile, PatientFile> get copyWith =>
      _PatientFileCopyWithImpl<PatientFile, PatientFile>(
          this as PatientFile, $identity, $identity);
  @override
  String toString() {
    return PatientFileMapper.ensureInitialized()
        .stringifyValue(this as PatientFile);
  }

  @override
  bool operator ==(Object other) {
    return PatientFileMapper.ensureInitialized()
        .equalsValue(this as PatientFile, other);
  }
