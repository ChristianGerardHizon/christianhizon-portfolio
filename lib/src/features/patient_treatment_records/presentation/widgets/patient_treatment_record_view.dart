...
import 'package:gym_system/src/features/patient_treatment_records/presentation/controllers/treatment_record/patient_treatment_records_controller.dart';
import 'package:gym_system/src/features/patient_treatment_records/presentation/sheets/treatment_record_create_sheet.dart';
import 'package:gym_system/src/features/patient_treatment_records/presentation/widgets/treatment_records_table.dart';
...
import 'package:gym_system/src/features/patient_treatment_records/domain/patient_treatment_record_search.dart';
import 'package:gym_system/src/features/patient_treatment_records/presentation/widgets/treatment_selector.dart';
...
class PatientTreatmentRecordView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final treatment = useState<PatientTreatment?>(null);

    final theme = Theme.of(context);
    final pageState = ref.watch(patientTreatmentRecordsPageControllerProvider);
    final searchNotif =
        ref.read(patientTreatmentRecordSearchControllerProvider.notifier);
    final provider = patientTreatmentRecordsControllerProvider(
    ...
    onTap(PatientTreatmentRecord record) {
      PatientTreatmentRecordPageRoute(record.id).push(context);
    }
          ...
          slivers: [
              ...
              child: TextSearchBar(
                ...
                onClear: () {
                  ...
                  searchNotif.updateParams(
                    PatientTreatmentRecordSearch.buildQuery(
                      searchCtrl.text,
                    ),
                  );
                },
                ...
                onCreate: () {
                  PatientTreatmentRecordCreateSheet.show(
                    context,
                    patient: patient,
            ...
            state.when(
              ...
              data: (data) {
                ...
                return PatientTreatmentRecordsTable(
                  list: list,
              ...
              sliver: SliverToBoxAdapter(
                child: PageSelector(
                  ...
                  onPageChange: (value) {
                    ...
                    selected.value = [];
                    ref
                        .read(patientTreatmentRecordsPageControllerProvider
                            .notifier)
                        .changePage(value);
                  },
                ),
