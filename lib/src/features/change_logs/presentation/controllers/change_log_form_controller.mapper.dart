...
class ChangeLogStateMapper extends ClassMapperBase<ChangeLogState> {
  ...
  static const Field<ChangeLogState, ChangeLog> _f$changeLog =
...
mixin ChangeLogStateMappable {
  String toJson() {
    return ChangeLogStateMapper.ensureInitialized()
        .encodeJson<ChangeLogState>(this as ChangeLogState);
  }

  Map<String, dynamic> toMap() {
    return ChangeLogStateMapper.ensureInitialized()
        .encodeMap<ChangeLogState>(this as ChangeLogState);
  }

  ChangeLogStateCopyWith<ChangeLogState, ChangeLogState, ChangeLogState>
      get copyWith =>
          _ChangeLogStateCopyWithImpl<ChangeLogState, ChangeLogState>(
              this as ChangeLogState, $identity, $identity);
  @override
  String toString() {
    return ChangeLogStateMapper.ensureInitialized()
        .stringifyValue(this as ChangeLogState);
  }

  @override
  bool operator ==(Object other) {
    return ChangeLogStateMapper.ensureInitialized()
        .equalsValue(this as ChangeLogState, other);
  }

  @override
  int get hashCode {
    return ChangeLogStateMapper.ensureInitialized()
        .hashValue(this as ChangeLogState);
  }
}
