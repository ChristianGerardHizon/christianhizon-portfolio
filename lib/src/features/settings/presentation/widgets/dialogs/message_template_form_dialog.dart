...
class MessageTemplateFormDialog extends HookConsumerWidget {
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _PlaceholderChip(
                          ...
                          onTap: () =>
                              insertPlaceholder('{patientPronounObject}'),
                        ),
                        _PlaceholderChip(
                          label: '{patientPronounPossessive}',
                          onTap: () =>
                              insertPlaceholder('{patientPronounPossessive}'),
                        ),
                      ],
                    ),
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _PlaceholderChip(
                          ...
                          onTap: () =>
                              insertPlaceholder('{appointmentMinutes}'),
                          isAppointment: true,
                        ),
                        _PlaceholderChip(
...
/// Shows the message template form dialog.
void showMessageTemplateFormDialog(
  ...
  showDialog(
    ...
    builder: (context) => Dialog(
      ...
      child: MessageTemplateFormDialog(template: template),
    ),
  );
}
