...
class PatientSpeciesMapper extends ClassMapperBase<PatientSpecies> {
  ...
  static const Field<PatientSpecies, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(PatientSpecies v) => v.collectionName;
  static const Field<PatientSpecies, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
  static String _$name(PatientSpecies v) => v.name;
  static const Field<PatientSpecies, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
    def: '',
  ...
  static const Field<PatientSpecies, bool> _f$isDeleted = Field(
    'isDeleted',
    _$isDeleted,
    opt: true,
    def: false,
  ...
  static const Field<PatientSpecies, DateTime> _f$created = Field(
    'created',
    _$created,
    opt: true,
  );
  static DateTime? _$updated(PatientSpecies v) => v.updated;
  static const Field<PatientSpecies, DateTime> _f$updated = Field(
    'updated',
    _$updated,
    opt: true,
  );
...
mixin PatientSpeciesMappable {
  String toJson() {
    return PatientSpeciesMapper.ensureInitialized().encodeJson<PatientSpecies>(
      this as PatientSpecies,
    );
  }

  Map<String, dynamic> toMap() {
    return PatientSpeciesMapper.ensureInitialized().encodeMap<PatientSpecies>(
      this as PatientSpecies,
    );
  }

  PatientSpeciesCopyWith<PatientSpecies, PatientSpecies, PatientSpecies>
  get copyWith => _PatientSpeciesCopyWithImpl<PatientSpecies, PatientSpecies>(
    this as PatientSpecies,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return PatientSpeciesMapper.ensureInitialized().stringifyValue(
      this as PatientSpecies,
    );
  }
  ...
  bool operator ==(Object other) {
    return PatientSpeciesMapper.ensureInitialized().equalsValue(
      this as PatientSpecies,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PatientSpeciesMapper.ensureInitialized().hashValue(
      this as PatientSpecies,
    );
  }
}
