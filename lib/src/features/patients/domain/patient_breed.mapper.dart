...
class PatientBreedMapper extends ClassMapperBase<PatientBreed> {
  ...
  static const Field<PatientBreed, String> _f$name = Field('name', _$name);
  static String _$speciesId(PatientBreed v) => v.speciesId;
  static const Field<PatientBreed, String> _f$speciesId = Field(
    'speciesId',
    _$speciesId,
  );
