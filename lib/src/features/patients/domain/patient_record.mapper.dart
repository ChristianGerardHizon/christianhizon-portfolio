...
class PatientRecordMapper extends ClassMapperBase<PatientRecord> {
  ...
  static String? _$note(PatientRecord v) => v.note;
  static const Field<PatientRecord, String> _f$note =
      Field('note', _$note, opt: true);
  static bool _$isDeleted(PatientRecord v) => v.isDeleted;
  static const Field<PatientRecord, bool> _f$isDeleted =
      Field('isDeleted', _$isDeleted, opt: true, def: false);
  static DateTime? _$created(PatientRecord v) => v.created;
  static const Field<PatientRecord, DateTime> _f$created =
...
mixin PatientRecordMappable {
  String toJson() {
    return PatientRecordMapper.ensureInitialized()
        .encodeJson<PatientRecord>(this as PatientRecord);
  }

  Map<String, dynamic> toMap() {
    return PatientRecordMapper.ensureInitialized()
        .encodeMap<PatientRecord>(this as PatientRecord);
  }
  ...
  PatientRecordCopyWith<PatientRecord, PatientRecord, PatientRecord>
      get copyWith => _PatientRecordCopyWithImpl<PatientRecord, PatientRecord>(
          this as PatientRecord, $identity, $identity);
  @override
  String toString() {
    return PatientRecordMapper.ensureInitialized()
        .stringifyValue(this as PatientRecord);
  }

  @override
  bool operator ==(Object other) {
    return PatientRecordMapper.ensureInitialized()
        .equalsValue(this as PatientRecord, other);
  }

  @override
  int get hashCode {
    return PatientRecordMapper.ensureInitialized()
        .hashValue(this as PatientRecord);
  }
}
