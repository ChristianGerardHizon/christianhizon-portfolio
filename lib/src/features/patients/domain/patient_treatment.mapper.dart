...
class PatientTreatmentMapper extends ClassMapperBase<PatientTreatment> {
  ...
  static String _$collectionId(PatientTreatment v) => v.collectionId;
  static const Field<PatientTreatment, String> _f$collectionId =
      Field('collectionId', _$collectionId);
  static String _$collectionName(PatientTreatment v) => v.collectionName;
  static const Field<PatientTreatment, String> _f$collectionName =
  ...
  static const Field<PatientTreatment, String> _f$icon =
      Field('icon', _$icon, opt: true);
  static bool _$isDeleted(PatientTreatment v) => v.isDeleted;
  static const Field<PatientTreatment, bool> _f$isDeleted =
      Field('isDeleted', _$isDeleted, opt: true, def: false);
  static DateTime? _$created(PatientTreatment v) => v.created;
  static const Field<PatientTreatment, DateTime> _f$created =
      Field('created', _$created, opt: true);
  static DateTime? _$updated(PatientTreatment v) => v.updated;
  static const Field<PatientTreatment, DateTime> _f$updated =
  ...
  PatientTreatmentCopyWith<PatientTreatment, PatientTreatment, PatientTreatment>
      get copyWith =>
          _PatientTreatmentCopyWithImpl<PatientTreatment, PatientTreatment>(
              this as PatientTreatment, $identity, $identity);
  @override
  String toString() {
    return PatientTreatmentMapper.ensureInitialized()
        .stringifyValue(this as PatientTreatment);
  }

  @override
  bool operator ==(Object other) {
    return PatientTreatmentMapper.ensureInitialized()
        .equalsValue(this as PatientTreatment, other);
  }

  @override
  int get hashCode {
    return PatientTreatmentMapper.ensureInitialized()
        .hashValue(this as PatientTreatment);
  }
}
...
extension PatientTreatmentValueCopy<$R, $Out>
  ...
  PatientTreatmentCopyWith<$R, PatientTreatment, $Out>
      get $asPatientTreatment => $base
          .as((v, t, t2) => _PatientTreatmentCopyWithImpl<$R, $Out>(v, t, t2));
}
