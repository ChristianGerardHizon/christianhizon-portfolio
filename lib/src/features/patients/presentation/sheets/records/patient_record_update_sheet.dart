...
import 'package:gym_system/src/features/patients/presentation/widgets/patients/patient_form_field.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';
import 'package:responsive_builder/responsive_builder.dart';

class PatientRecordUpdateSheet extends HookConsumerWidget {
  final PatientRecord record;

  const PatientRecordUpdateSheet({
    super.key,
  ...
  static Future<bool?> show(
    ...
    return showDialog<bool>(
      ...
      context: context,
      builder: (context) {
        return PatientRecordUpdateSheet(record: record);
      },
    );
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void onSubmit() async {
      ...
      final result = await ref
          .read(patientRecordRepositoryProvider)
          .update(record, form.value)
          .run();
    ...
    Map<String, dynamic> buildInitialValue(Patient patient) {
      return {
        PatientRecordField.id: record.id,
        PatientRecordField.followUpDate: record.followUpDate,
        PatientRecordField.vistDate: record.visitDate,
        PatientRecordField.patient: patient,
        PatientRecordField.treatment: record.treatment,
        PatientRecordField.diagnosis: record.diagnosis,
      };
    }
    ...
    final content = Padding(
      ...
      child: Scaffold(
        ...
        body: ref.watch(patientControllerProvider(record.patient)).when(
              skipError: false,
              ...
              data: (patient) => FormBuilder(
                key: formKey,
                initialValue: buildInitialValue(patient),
