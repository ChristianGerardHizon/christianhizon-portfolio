...
class PatientRecordCreateSheet extends HookConsumerWidget {
  final Patient patient;
  final PatientRecord? record;

  const PatientRecordCreateSheet({
    super.key,
  ...
  static Future<bool?> show(
    ...
    return showDialog<bool>(
      ...
      context: context,
      builder: (context) {
        return PatientRecordCreateSheet(
          patient: patient,
        );
      },
    );
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void onSubmit() async {
      ...
      result.fold(
        ...
        (r) {
          ...
          ref.invalidate(patientRecordsPageControllerProvider);
          context.pop();
        },
      );
    }
    ...
    Map<String, dynamic> buildInitialValue() {
      return {
        ...
        PatientRecordField.vistDate: record?.visitDate ?? DateTime.now(),
