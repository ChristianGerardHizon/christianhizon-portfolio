...
class PatientPrescriptionItemCreateSheet extends HookConsumerWidget {
  final PatientRecord patientRecord;

  final Map<String, dynamic>? formData;

  const PatientPrescriptionItemCreateSheet({
    super.key,
  ...
  static Future show(
    ...
    return showDialog(
      ...
      useSafeArea: true,
      builder: (_) => PatientPrescriptionItemCreateSheet(
    ...
    void onSubmit() async {
      ...
      result.fold(
        ...
        (r) {
          ...
          ref.invalidate(patientPrescriptionItemsPageControllerProvider);
          context.pop(r);
        },
      );
    }
