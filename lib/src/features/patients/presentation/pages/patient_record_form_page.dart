...
import 'package:gym_system/src/features/patients/presentation/controllers/patient_record/patient_record_form_controller.dart';
          ...
          data: (formState) {
            ...
            return DynamicFormBuilder(
              ...
              fields: [
                ...
                ///
                DynamicTextField(
                  name: PatientRecordField.note,
                  initialValue: patientRecord?.note,
                  decoration: InputDecoration(
                    label: Text('Note'),
                    border: OutlineInputBorder(),
                  ),
