...
import 'package:gym_system/src/features/patients/presentation/sheets/prescriptions/patient_prescription_item_update_sheet.dart';
import 'package:gym_system/src/features/patients/presentation/widgets/prescriptions/patient_prescription_items_pdf_generator.dart';
...
class PrescriptionListView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final provider =
        patientPrescriptionAllItemsControllerProvider(id: record.id);
    ...
    onPrescriptionAdd() async {
      final result = await PatientPrescriptionItemCreateSheet.show(context,
          record: record);
