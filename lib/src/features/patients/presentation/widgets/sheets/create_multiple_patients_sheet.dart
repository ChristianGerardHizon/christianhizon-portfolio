...
class CreateMultiplePatientsSheet extends HookConsumerWidget {
  const CreateMultiplePatientsSheet({super.key, this.scrollController});
...
/// Shows the create multiple patients sheet as a modal bottom sheet.
void showCreateMultiplePatientsSheet(BuildContext context) {
