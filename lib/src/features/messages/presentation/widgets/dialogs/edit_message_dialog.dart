                                ...
                                onChanged: (value) async {
                                  if (value != null) {
                                    ...
                                    if (template.branch != null) {
                                      ...
                                      if (branchData != null) {
                                        branchName = branchData.displayName ??
                                            branchData.name;
                                    ...
                                    if (message.appointment != null) {
                                      final appointmentData = await ref.read(
                                        appointmentProvider(message.appointment!)
                                            .future,
                                      );
