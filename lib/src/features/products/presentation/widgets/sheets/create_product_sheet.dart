...
/// Bottom sheet for creating a new product.
class CreateProductSheet extends HookConsumerWidget {
  const CreateProductSheet({super.key, this.scrollController});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Create Product', style: theme.textTheme.titleLarge),
...
/// Shows the create product sheet as a modal bottom sheet.
void showCreateProductSheet(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (context) => DraggableScrollableSheet(
      ...
      maxChildSize: 0.95,
      expand: false,
      builder: (context, scrollController) => CreateProductSheet(
