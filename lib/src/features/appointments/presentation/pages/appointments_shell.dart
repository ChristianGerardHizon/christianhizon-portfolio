...
import '../widgets/tablet_appointments_layout.dart';

/// Adaptive shell for appointments list/detail layout.
///
...
class AppointmentsShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isTablet) {
      ...
      return TabletAppointmentsLayout(detailChild: child);
    }
