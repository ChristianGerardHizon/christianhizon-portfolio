...
class MedicalRecordUpdateSheet extends HookConsumerWidget {
  final MedicalRecord record;

  const MedicalRecordUpdateSheet({
    super.key,
  ...
  static Future<bool?> show(
    ...
    return showDialog<bool>(
      ...
      context: context,
      builder: (context) {
        return MedicalRecordUpdateSheet(record: record);
      },
    );
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Map<String, dynamic> buildInitialValue(Patient patient) {
      return {
        ...
        MedicalRecordField.vistDate: record.visitDate,
