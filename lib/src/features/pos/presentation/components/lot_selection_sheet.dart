...
/// Bottom sheet for selecting a lot when adding a lot-tracked product to cart.
///
...
class LotSelectionSheet extends HookConsumerWidget {
  const LotSelectionSheet({
    super.key,
  ...
  /// Optional scroll controller for draggable sheet.
...
/// Shows the lot selection sheet for a product.
void showLotSelectionSheet(
  ...
  showModalBottomSheet(
    ...
    builder: (context) => DraggableScrollableSheet(
      ...
      maxChildSize: 0.95,
      expand: false,
      builder: (context, scrollController) => LotSelectionSheet(
        product: product,
