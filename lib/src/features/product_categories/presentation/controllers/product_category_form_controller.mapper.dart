  ...
  static ProductCategoryFormStateMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = ProductCategoryFormStateMapper._(),
      );
...
mixin ProductCategoryFormStateMappable {
  ...
  ProductCategoryFormStateCopyWith<
    ProductCategoryFormState,
    ProductCategoryFormState,
    ProductCategoryFormState
  >
  get copyWith =>
      _ProductCategoryFormStateCopyWithImpl<
        ProductCategoryFormState,
        ProductCategoryFormState
      >(this as ProductCategoryFormState, $identity, $identity);
  @override
  String toString() {
    return ProductCategoryFormStateMapper.ensureInitialized().stringifyValue(
      this as ProductCategoryFormState,
    );
  }

  @override
  bool operator ==(Object other) {
    return ProductCategoryFormStateMapper.ensureInitialized().equalsValue(
      this as ProductCategoryFormState,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ProductCategoryFormStateMapper.ensureInitialized().hashValue(
      this as ProductCategoryFormState,
    );
  }
}
...
extension ProductCategoryFormStateValueCopy<$R, $Out>
  ...
  get $asProductCategoryFormState => $base.as(
    (v, t, t2) => _ProductCategoryFormStateCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
