...
class ProductCategoryMapper extends ClassMapperBase<ProductCategory> {
  ...
  static const Field<ProductCategory, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(ProductCategory v) => v.collectionName;
  static const Field<ProductCategory, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
  ...
  static const Field<ProductCategory, String> _f$parent = Field(
    'parent',
    _$parent,
    opt: true,
  );
