      ...
      branches: [
        ...
        StatefulShellBranchData.$branch(
          routes: [
            ...
            GoRouteData.$route(
              path: '/products/stocks/:id',
              factory: $ProductStockPageRoute._fromState,
            ),
            GoRouteData.$route(
              path: '/products/stocks/form',
            ...
            GoRouteData.$route(
              path: '/products/adjustments/form',
        ...
        StatefulShellBranchData.$branch(
          routes: [
            ...
            GoRouteData.$route(
              path: '/organization/admins/:id',
              factory: $AdminPageRoute._fromState,
            ),
            GoRouteData.$route(
              path: '/organization/admins/form',
            ...
            GoRouteData.$route(
              path: '/organization/branches/form',
        ...
        StatefulShellBranchData.$branch(
          routes: [
            ...
            GoRouteData.$route(
              path: '/system/change-logs/:id',
              factory: $ChangeLogPageRoute._fromState,
            ),
            GoRouteData.$route(
              path: '/system/change-logs/form',
...
mixin $PatientRecordPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/patients/records/${Uri.encodeComponent(_self.id)}',
      );
...
mixin $PatientTreatmentRecordPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/patients/treatment-records/${Uri.encodeComponent(_self.id)}',
      );
...
mixin $PatientTreatmentRecordFormPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/patients/treatment-records/form',
        queryParams: {
          'parent-id': _self.parentId,
          if (_self.id != null) 'id': _self.id,
        },
...
mixin $PatientSpeciesPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/patient-config/species/${Uri.encodeComponent(_self.id)}',
      );
...
mixin $PatientTreatmentFormPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/patient-config/treatments/form',
        queryParams: {
          if (_self.id != null) 'id': _self.id,
        },
      );
...
mixin $ProductStockPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/products/stocks/${Uri.encodeComponent(_self.id)}',
      );
...
mixin $ProductCategoryPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/products/categories/${Uri.encodeComponent(_self.id)}',
      );
...
mixin $AdminPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/organization/admins/${Uri.encodeComponent(_self.id)}',
      );
...
mixin $ChangeLogPageRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location(
        '/system/change-logs/${Uri.encodeComponent(_self.id)}',
      );
