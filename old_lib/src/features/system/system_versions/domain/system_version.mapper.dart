...
class SystemVersionMapper extends ClassMapperBase<SystemVersion> {
  ...
  static const Field<SystemVersion, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(SystemVersion v) => v.collectionName;
  static const Field<SystemVersion, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
  static bool _$isDeleted(SystemVersion v) => v.isDeleted;
  static const Field<SystemVersion, bool> _f$isDeleted = Field(
    'isDeleted',
    _$isDeleted,
    opt: true,
    def: false,
  ...
  static const Field<SystemVersion, DateTime> _f$created = Field(
    'created',
    _$created,
    opt: true,
  );
  static DateTime? _$updated(SystemVersion v) => v.updated;
  static const Field<SystemVersion, DateTime> _f$updated = Field(
    'updated',
    _$updated,
    opt: true,
  );
  static num _$buildNumber(SystemVersion v) => v.buildNumber;
  static const Field<SystemVersion, num> _f$buildNumber = Field(
    'buildNumber',
    _$buildNumber,
  );
  static List<SystemArtifact> _$artifacts(SystemVersion v) => v.artifacts;
  static const Field<SystemVersion, List<SystemArtifact>> _f$artifacts = Field(
    'artifacts',
    _$artifacts,
    opt: true,
    def: const [],
...
mixin SystemVersionMappable {
  String toJson() {
    return SystemVersionMapper.ensureInitialized().encodeJson<SystemVersion>(
      this as SystemVersion,
    );
  }

  Map<String, dynamic> toMap() {
    return SystemVersionMapper.ensureInitialized().encodeMap<SystemVersion>(
      this as SystemVersion,
    );
  }
  ...
  @override
  String toString() {
    return SystemVersionMapper.ensureInitialized().stringifyValue(
      this as SystemVersion,
    );
  }
  ...
  bool operator ==(Object other) {
    return SystemVersionMapper.ensureInitialized().equalsValue(
      this as SystemVersion,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SystemVersionMapper.ensureInitialized().hashValue(
      this as SystemVersion,
    );
  }
}
