...
class UserMapper extends ClassMapperBase<User> {
  ...
  static const Field<User, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(User v) => v.collectionName;
  static const Field<User, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
...
class UserExpandMapper extends ClassMapperBase<UserExpand> {
  ...
  static const Field<UserExpand, Branch> _f$branch = Field(
    'branch',
    _$branch,
    opt: true,
  );
  ...
  @override
  final MappableFields<UserExpand> fields = const {#branch: _f$branch};
...
mixin UserExpandMappable {
  String toJson() {
    return UserExpandMapper.ensureInitialized().encodeJson<UserExpand>(
      this as UserExpand,
    );
  }

  Map<String, dynamic> toMap() {
    return UserExpandMapper.ensureInitialized().encodeMap<UserExpand>(
      this as UserExpand,
    );
  }
  ...
  @override
  String toString() {
    return UserExpandMapper.ensureInitialized().stringifyValue(
      this as UserExpand,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return UserExpandMapper.ensureInitialized().equalsValue(
      this as UserExpand,
      other,
    );
  }
