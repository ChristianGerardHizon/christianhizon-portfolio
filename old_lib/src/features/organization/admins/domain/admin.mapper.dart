...
class AdminMapper extends ClassMapperBase<Admin> {
  ...
  static const Field<Admin, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(Admin v) => v.collectionName;
  static const Field<Admin, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
  ...
  static const Field<Admin, String> _f$branch = Field(
    'branch',
    _$branch,
    opt: true,
    hook: PbEmptyHook(),
  ...
  static const Field<Admin, String> _f$email = Field(
    'email',
    _$email,
    opt: true,
    def: '',
  ...
  static const Field<Admin, String> _f$avatar = Field(
    'avatar',
    _$avatar,
    opt: true,
  );
  static bool _$verified(Admin v) => v.verified;
  static const Field<Admin, bool> _f$verified = Field(
    'verified',
    _$verified,
    opt: true,
    def: false,
  ...
  static const Field<Admin, bool> _f$isDeleted = Field(
    'isDeleted',
    _$isDeleted,
    opt: true,
    def: false,
  ...
  static const Field<Admin, DateTime> _f$created = Field(
    'created',
    _$created,
    opt: true,
  );
  static DateTime? _$updated(Admin v) => v.updated;
  static const Field<Admin, DateTime> _f$updated = Field(
    'updated',
    _$updated,
    opt: true,
  );
...
class AdminExpandMapper extends ClassMapperBase<AdminExpand> {
  ...
  static const Field<AdminExpand, Branch> _f$branch = Field(
    'branch',
    _$branch,
    opt: true,
  );
  ...
  @override
  final MappableFields<AdminExpand> fields = const {#branch: _f$branch};
...
mixin AdminExpandMappable {
  String toJson() {
    return AdminExpandMapper.ensureInitialized().encodeJson<AdminExpand>(
      this as AdminExpand,
    );
  }

  Map<String, dynamic> toMap() {
    return AdminExpandMapper.ensureInitialized().encodeMap<AdminExpand>(
      this as AdminExpand,
    );
  }
  ...
  @override
  String toString() {
    return AdminExpandMapper.ensureInitialized().stringifyValue(
      this as AdminExpand,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return AdminExpandMapper.ensureInitialized().equalsValue(
      this as AdminExpand,
      other,
    );
  }
