...
class PatientMapper extends ClassMapperBase<Patient> {
  ...
  static const Field<Patient, String> _f$collectionId = Field(
    'collectionId',
    _$collectionId,
  );
  static String _$collectionName(Patient v) => v.collectionName;
  static const Field<Patient, String> _f$collectionName = Field(
    'collectionName',
    _$collectionName,
  );
  static String _$name(Patient v) => v.name;
  static const Field<Patient, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
    def: '',
  ...
  static const Field<Patient, PatientRecordExpand> _f$expand = Field(
    'expand',
    _$expand,
  );
...
class PatientRecordExpandMapper extends ClassMapperBase<PatientRecordExpand> {
  ...
  static const Field<PatientRecordExpand, PatientSpecies> _f$species = Field(
    'species',
    _$species,
    opt: true,
  );
  static PatientBreed? _$breed(PatientRecordExpand v) => v.breed;
  static const Field<PatientRecordExpand, PatientBreed> _f$breed = Field(
    'breed',
    _$breed,
    opt: true,
  );
  static Branch? _$branch(PatientRecordExpand v) => v.branch;
  static const Field<PatientRecordExpand, Branch> _f$branch = Field(
    'branch',
    _$branch,
    opt: true,
  );
...
mixin PatientRecordExpandMappable {
  ...
  PatientRecordExpandCopyWith<
    PatientRecordExpand,
    PatientRecordExpand,
    PatientRecordExpand
  >
  get copyWith =>
      _PatientRecordExpandCopyWithImpl<
        PatientRecordExpand,
        PatientRecordExpand
      >(this as PatientRecordExpand, $identity, $identity);
  @override
  String toString() {
    return PatientRecordExpandMapper.ensureInitialized().stringifyValue(
      this as PatientRecordExpand,
    );
  }

  @override
  bool operator ==(Object other) {
    return PatientRecordExpandMapper.ensureInitialized().equalsValue(
      this as PatientRecordExpand,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PatientRecordExpandMapper.ensureInitialized().hashValue(
      this as PatientRecordExpand,
    );
  }
}
...
abstract class PatientRecordExpandCopyWith<
  $R,
  $In extends PatientRecordExpand,
  $Out
>
