...
class PatientFormStateMapper extends ClassMapperBase<PatientFormState> {
  ...
  static const Field<PatientFormState, Patient> _f$patient = Field(
    'patient',
    _$patient,
  );
  static List<Branch> _$branches(PatientFormState v) => v.branches;
  static const Field<PatientFormState, List<Branch>> _f$branches = Field(
    'branches',
    _$branches,
    opt: true,
    def: const [],
  ...
  static const Field<PatientFormState, List<PBFile>> _f$images = Field(
    'images',
    _$images,
    opt: true,
  );
  static List<PatientSpecies> _$species(PatientFormState v) => v.species;
  static const Field<PatientFormState, List<PatientSpecies>> _f$species = Field(
    'species',
    _$species,
    opt: true,
    def: const [],
  ...
  static const Field<PatientFormState, List<PatientBreed>> _f$breeds = Field(
    'breeds',
    _$breeds,
    opt: true,
    def: const [],
  ...
  static const Field<PatientFormState, List<PatientSex>> _f$sexes = Field(
    'sexes',
    _$sexes,
    opt: true,
    def: const [],
...
mixin PatientFormStateMappable {
  ...
  get copyWith =>
      _PatientFormStateCopyWithImpl<PatientFormState, PatientFormState>(
        this as PatientFormState,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PatientFormStateMapper.ensureInitialized().stringifyValue(
      this as PatientFormState,
    );
  }
  ...
  bool operator ==(Object other) {
    return PatientFormStateMapper.ensureInitialized().equalsValue(
      this as PatientFormState,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PatientFormStateMapper.ensureInitialized().hashValue(
      this as PatientFormState,
    );
  }
}
...
extension PatientFormStateValueCopy<$R, $Out>
  ...
  get $asPatientFormState =>
      $base.as((v, t, t2) => _PatientFormStateCopyWithImpl<$R, $Out>(v, t, t2));
}
