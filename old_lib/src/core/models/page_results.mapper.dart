...
class PageResultsMapper extends ClassMapperBase<PageResults> {
  ...
  static const Field<PageResults, int> _f$totalItems = Field(
    'totalItems',
    _$totalItems,
  );
  static int _$totalPages(PageResults v) => v.totalPages;
  static const Field<PageResults, int> _f$totalPages = Field(
    'totalPages',
    _$totalPages,
  );
  static List<dynamic> _$items(PageResults v) => v.items;
  static dynamic _arg$items<T>(f) => f<List<T>>();
  static const Field<PageResults, List<dynamic>> _f$items = Field(
    'items',
    _$items,
    arg: _arg$items,
  );
...
mixin PageResultsMappable<T> {
  String toJson() {
    return PageResultsMapper.ensureInitialized().encodeJson<PageResults<T>>(
      this as PageResults<T>,
    );
  }

  Map<String, dynamic> toMap() {
    return PageResultsMapper.ensureInitialized().encodeMap<PageResults<T>>(
      this as PageResults<T>,
    );
  }

  PageResultsCopyWith<PageResults<T>, PageResults<T>, PageResults<T>, T>
  get copyWith => _PageResultsCopyWithImpl<PageResults<T>, PageResults<T>, T>(
    this as PageResults<T>,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return PageResultsMapper.ensureInitialized().stringifyValue(
      this as PageResults<T>,
    );
  }
  ...
  bool operator ==(Object other) {
    return PageResultsMapper.ensureInitialized().equalsValue(
      this as PageResults<T>,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PageResultsMapper.ensureInitialized().hashValue(
      this as PageResults<T>,
    );
  }
}
