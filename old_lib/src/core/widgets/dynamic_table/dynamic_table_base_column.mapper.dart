...
class DynamicTableBaseColumnMapper
  ...
  static const Field<DynamicTableBaseColumn, double> _f$width = Field(
    'width',
    _$width,
  );
  static String? _$key(DynamicTableBaseColumn v) => v.key;
  static const Field<DynamicTableBaseColumn, String> _f$key = Field(
    'key',
    _$key,
    opt: true,
  );
  static int _$freezePriority(DynamicTableBaseColumn v) => v.freezePriority;
  static const Field<DynamicTableBaseColumn, int> _f$freezePriority = Field(
    'freezePriority',
    _$freezePriority,
    opt: true,
    def: 0,
  ...
  static const Field<DynamicTableBaseColumn, bool> _f$sticky = Field(
    'sticky',
    _$sticky,
    opt: true,
    def: false,
  ...
  static const Field<DynamicTableBaseColumn, int> _f$flex = Field(
    'flex',
    _$flex,
    opt: true,
    def: 0,
  ...
  static const Field<DynamicTableBaseColumn, double> _f$translation = Field(
    'translation',
    _$translation,
    opt: true,
    def: 0,
  ...
  static const Field<DynamicTableBaseColumn, double> _f$minResizeWidth = Field(
    'minResizeWidth',
    _$minResizeWidth,
    opt: true,
  );
  static double? _$maxResizeWidth(DynamicTableBaseColumn v) => v.maxResizeWidth;
  static const Field<DynamicTableBaseColumn, double> _f$maxResizeWidth = Field(
    'maxResizeWidth',
    _$maxResizeWidth,
    opt: true,
  );
  ...
  static const Field<DynamicTableBaseColumn, Function> _f$builder = Field(
    'builder',
    _$builder,
    arg: _arg$builder,
  );
...
mixin DynamicTableBaseColumnMappable {
  ...
  DynamicTableBaseColumnCopyWith<
    DynamicTableBaseColumn,
    DynamicTableBaseColumn,
    DynamicTableBaseColumn
  >
  get copyWith =>
      _DynamicTableBaseColumnCopyWithImpl<
        DynamicTableBaseColumn,
        DynamicTableBaseColumn
      >(this as DynamicTableBaseColumn, $identity, $identity);
  @override
  String toString() {
    return DynamicTableBaseColumnMapper.ensureInitialized().stringifyValue(
      this as DynamicTableBaseColumn,
    );
  }

  @override
  bool operator ==(Object other) {
    return DynamicTableBaseColumnMapper.ensureInitialized().equalsValue(
      this as DynamicTableBaseColumn,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return DynamicTableBaseColumnMapper.ensureInitialized().hashValue(
      this as DynamicTableBaseColumn,
    );
  }
}
...
extension DynamicTableBaseColumnValueCopy<$R, $Out>
  ...
  get $asDynamicTableBaseColumn => $base.as(
    (v, t, t2) => _DynamicTableBaseColumnCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
