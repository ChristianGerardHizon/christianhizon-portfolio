...
class DynamicTableColumnMapper extends ClassMapperBase<DynamicTableColumn> {
  ...
  Function get typeFactory =>
      <T>(f) => f<DynamicTableColumn<T>>();

  static String _$header(DynamicTableColumn v) => v.header;
  static const Field<DynamicTableColumn, String> _f$header = Field(
    'header',
    _$header,
  );
  static String? _$sortKey(DynamicTableColumn v) => v.sortKey;
  static const Field<DynamicTableColumn, String> _f$sortKey = Field(
    'sortKey',
    _$sortKey,
    opt: true,
  );
  static Alignment? _$alignment(DynamicTableColumn v) => v.alignment;
  static const Field<DynamicTableColumn, Alignment> _f$alignment = Field(
    'alignment',
    _$alignment,
    opt: true,
  );
  static EdgeInsets? _$padding(DynamicTableColumn v) => v.padding;
  static const Field<DynamicTableColumn, EdgeInsets> _f$padding = Field(
    'padding',
    _$padding,
    opt: true,
  );
  static TextStyle? _$style(DynamicTableColumn v) => v.style;
  static const Field<DynamicTableColumn, TextStyle> _f$style = Field(
    'style',
    _$style,
    opt: true,
  );
  static double _$width(DynamicTableColumn v) => v.width;
  static const Field<DynamicTableColumn, double> _f$width = Field(
    'width',
    _$width,
    opt: true,
    def: 100,
  ...
  static const Field<DynamicTableColumn, int> _f$flex = Field(
    'flex',
    _$flex,
    opt: true,
    def: 0,
  ...
  static const Field<DynamicTableColumn, double> _f$translation = Field(
    'translation',
    _$translation,
    opt: true,
    def: 0,
  ...
  static const Field<DynamicTableColumn, double> _f$minResizeWidth = Field(
    'minResizeWidth',
    _$minResizeWidth,
    opt: true,
  );
  static double? _$maxResizeWidth(DynamicTableColumn v) => v.maxResizeWidth;
  static const Field<DynamicTableColumn, double> _f$maxResizeWidth = Field(
    'maxResizeWidth',
    _$maxResizeWidth,
    opt: true,
  );
  ...
  static const Field<DynamicTableColumn, Function?> _f$builder = Field(
    'builder',
    _$builder,
    opt: true,
    arg: _arg$builder,
...
mixin DynamicTableColumnMappable<T> {
  ...
  >
  get copyWith =>
      _DynamicTableColumnCopyWithImpl<
        DynamicTableColumn<T>,
        DynamicTableColumn<T>,
        T
      >(this as DynamicTableColumn<T>, $identity, $identity);
  @override
  String toString() {
    return DynamicTableColumnMapper.ensureInitialized().stringifyValue(
      this as DynamicTableColumn<T>,
    );
  }

  @override
  bool operator ==(Object other) {
    return DynamicTableColumnMapper.ensureInitialized().equalsValue(
      this as DynamicTableColumn<T>,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return DynamicTableColumnMapper.ensureInitialized().hashValue(
      this as DynamicTableColumn<T>,
    );
  }
}
...
abstract class DynamicTableColumnCopyWith<
  $R,
  $In extends DynamicTableColumn<T>,
  $Out,
  T
>
